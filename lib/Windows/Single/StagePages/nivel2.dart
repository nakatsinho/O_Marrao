...
import 'package:o_marrao/Windows/Single/NiveisPointsPages/nivel3.dart';
...
class Nivel2 extends StatefulWidget {
  Nivel2({this.username, this.emailv});
...
class _SingleHomeState extends State<Nivel2> {
  _SingleHomeState() {
    init();
  }
          ...
          () => this.setState(() {
                Navigator.of(context).push(new MaterialPageRoute(
                    builder: (BuildContext context) =>
                        new NivelP3(_score, _quizQuestions.length,_level)));
              }));
    }
