...
import 'package:o_marrao/Windows/Single/NiveisPointsPages/nivel4.dart';
...
class Nivel3 extends StatefulWidget {
  Nivel3({this.username, this.emailv});
...
class _SingleHomeState extends State<Nivel3> {
  _SingleHomeState() {
    init();
  }
  ...
  QuestionList _quizQuestions = new QuestionList([
                                                   ...
                                                   new Question(
                                                       "A quiropraxia é o sistema de tratamento das doenças pela: ",
                                                       "Manipulação de pensamentos",
                                                       "Manipulação das vértebras",
                                                   ...
                                                   new Question(
                                                       "Todas a palavras fazem parte do mesmo campo semântico, excepto:",
                                                       "Peixe",
                                                       "Anzol",
                                                       "Antena",
                                                       "Carapau",
      ...
      Timer(
          Duration(seconds: 2),
            ...
            Navigator.of(context).push(new MaterialPageRoute(
                builder: (BuildContext context) => new NivelP4(_score, _quizQuestions.length,_level)));
          }));
  ...
  void _alertNivel2() {
    AlertDialog alertsnivel2 = new AlertDialog(
      title: new Text(
        "Wow... Subiu de nivel " + _nivel + "!",
        style: TextStyle(color: Colors.red),
        textAlign: TextAlign.center,
