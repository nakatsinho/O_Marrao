...
import 'package:o_marrao/Windows/Single/NiveisPointsPages/nivel6.dart';
import 'package:o_marrao/Windows/Single/points.dart';
import 'package:flutter/foundation.dart';
import 'package:o_marrao/Windows/settings.dart';

class Nivel5 extends StatefulWidget {
  Nivel5({this.username, this.emailv});
...
class _SingleHomeState extends State<Nivel5> {
  _SingleHomeState() {
    init();
  }
    ...
    if (_questionNumber == _quizQuestions.length) {
      Timer(
          ...
          () => this.setState(() {
                Navigator.of(context).push(new MaterialPageRoute(
                    builder: (BuildContext context) =>
                        new NivelP6(_score, _quizQuestions.length,_level)));
              }));
      _value = 0.0;
    }
