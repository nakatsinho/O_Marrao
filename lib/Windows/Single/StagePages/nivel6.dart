...
import 'package:o_marrao/Windows/Single/endpoints.dart';
import 'package:flutter/foundation.dart';
import 'package:o_marrao/Windows/Single/points.dart';
import 'package:o_marrao/Windows/settings.dart';

class Nivel6 extends StatefulWidget {
  Nivel6({this.username, this.emailv});
...
class _SingleHomeState extends State<Nivel6> {
  _SingleHomeState() {
    init();
  }
    ...
    if (_questionNumber == _quizQuestions.length) {
      Timer(
          ...
          () => this.setState(() {
                Navigator.of(context).push(new MaterialPageRoute(
                    builder: (BuildContext context) =>
                        new EPointsPage(_score, _quizQuestions.length,_level)));
              }));
      _value = 0.0;
    }
