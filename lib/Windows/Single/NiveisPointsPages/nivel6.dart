...
import 'package:o_marrao/Windows/Single/StagePages/nivel5.dart';
import 'package:o_marrao/Windows/Single/StagePages/nivel6.dart';
import 'package:o_marrao/Windows/Single/player1.dart';
import 'package:o_marrao/principal.dart';

class NivelP6 extends StatefulWidget {
  final int _score;
  final int _totalQuestion;
  final String _level;

  NivelP6(this._score, this._totalQuestion, this._level);
...
class PointsPageState extends State<NivelP6>
